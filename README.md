...
1) Quick feature tour in the UI
2) Show the expense CRUD flow and how it maps to controllers/services
3) Highlight summary aggregation logic and budget alert calculation
4) Show CSV export route and response
5) Mention Docker + Postgres setup and how to run locally
